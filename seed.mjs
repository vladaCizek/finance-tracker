...
const supabase = createClient(
  ...
  process.env.SUPABASE_SERVICE_KEY, // My Service Key, that allows me to bypass auth
  {
...
// Using the Service key, get all users and exctract ids
const {
  data: { users },
  error,
...
if (error) {
  console.log("No Users found. Got error.");
  process.exit();
}
...
async function seedTransactions() {
  ...
  // loop all the ids and create some data
